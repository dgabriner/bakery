...
| Production Manager Dashboard | `production_manager.php`, `includes/production_manager_dashboard.php` | Dough-first expandable board: pieces, batch size (gal/tray), dough weight, SKU detail, vs prior week. Links into Production Center for edit/commit. |
