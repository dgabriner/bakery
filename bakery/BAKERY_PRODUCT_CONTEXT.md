...
| **Cashier** | Add bakery or store items and capture catalog photos. Sees **Add Product** + **Product Photos** (`cashier_add_product.php`, `product_photos.php`, upload API). Initial user: Sarita, code `8989`. |
