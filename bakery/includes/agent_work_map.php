    ...
    return [
        ...
        'bread-education' => [
            ...
            'files' => [
                ...
                'breadeducation/sitemap.xml',
                'breadeducation/classes/classes.html',
                'breadeducation/classes/corporate-workshops.html',
                'breadeducation/classes/private-events.html',
                'breadeducation/classes/visit-plan.html',
                'breadeducation/sell/find-our-bread.html',
                'breadeducation/sell/wholesale.html',
                'breadeducation/pan-dulce/index.html',
                'breadeducation/es/index.html',
                'domain_root/llms.txt',
                'breadeducation/',
        ...
        'agent-os' => [
            ...
            'files' => [
                ...
                'scripts/ox/ox.php',
                'scripts/ox/ox_send.php',
                'scripts/ox/ox_lib.php',
            ],
            'tests' => [
                'tests/run_agent_homebase_tests.php',
                'tests/run_agent_work_map_tests.php',
                'tests/run_ox_controller_tests.php',
                'tests/run_i18n_tests.php',
        ...
        'auth' => [
            ...
            'files' => [
                ...
                'counter_orders.php',
                'includes/counter_orders.php',
                'css/counter_orders.css',
                'time_clock.php',
                'includes/time_clock.php',
                'css/time_clock.css',
                'product_photos.php',
            ...
            'tests' => [
                ...
                'tests/run_counter_orders_tests.php',
                'tests/run_time_clock_tests.php',
            ],
            'invariants' => [
