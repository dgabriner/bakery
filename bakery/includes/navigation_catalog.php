...
function bakery_navigation_catalog() {
    return [
        ...
        [
            ...
            'roles' => ['administrator', 'manager'],
            'items' => [
                ['href' => 'production_center.php', 'label' => 'Production Center', 'description' => 'Weekly finished-goods planning using orders and stock.', 'roles' => ['administrator', 'manager'], 'usage' => 'moderate'],
        ...
        [
            ...
            'items' => [
                ...
                ['href' => 'billing_center.php', 'label' => 'Billing Center', 'description' => 'Customer accounts, delivery invoices, statements, and accounting export — not driver COD cash.', 'roles' => ['administrator', 'manager'], 'usage' => 'moderate'],
