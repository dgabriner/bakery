...
function Get-BakeryDeployRootFiles {
    return @(
        ...
        'daily_orders.php', 'daily_orders_api.php', 'standing_orders.php', 'standing_orders_manager.php', 'standing_orders_manager_api.php', 'orders.php',
        ...
        'cashier_shop_photos.php', 'upload_shop_photo.php', 'counter_orders.php', 'time_clock.php',
