...
$assert(strpos($pushStage, 'snapshot_dreamhost_staging.php') !== false, 'staging push snapshots bakerysoftware on schema change');
$assert(strpos($pushStage, '--mode=dreamhost-stage') !== false, 'staging push runs dreamhost-stage migrations');
