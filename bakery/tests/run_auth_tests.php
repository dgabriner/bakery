...
t_assert(bakery_role_home('cashier') === 'time_clock.php', 'cashier home is the time clock');
...
t_assert(bakery_ops_index_bypass_home('cashier') === 'time_clock.php', 'cashiers hitting the ops dashboard are sent to the time clock');
