...
$assert(bakery_schema_next_migration_number() === 79, 'next unused schema number is 079');
$assert(bakery_schema_next_migration_id('demo_feature') === '079_demo_feature', 'next id is 079_ plus slug');
