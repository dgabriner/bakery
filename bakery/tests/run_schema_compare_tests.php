...
$assert(bakery_schema_next_migration_number() === 80, 'next unused schema number is 080');
$assert(bakery_schema_next_migration_id('demo_feature') === '080_demo_feature', 'next id is 080_ plus slug');
