...
$assert(bakery_schema_next_migration_number() === 81, 'next unused schema number is 081');
$assert(bakery_schema_next_migration_id('demo_feature') === '081_demo_feature', 'next id is 081_ plus slug');
