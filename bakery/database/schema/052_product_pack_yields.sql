-- Pack yields: gallon / tray / barra language → sellable pieces.
-- Orders, plans, and inventory stay in whole pieces; this table is conversion reference.
...
-- Concha + Fino: 3 gal → 44 trays → 880 pieces ⇒ trays/gal = 44/3, 20 pcs/tray
...
-- Tray-cut mantecadas / budín
INSERT INTO product_pack_yields (product_id, input_unit, pieces_per_input, pieces_per_tray, notes)
...
-- Whole Barras
INSERT INTO product_pack_yields (product_id, input_unit, pieces_per_input, notes)
...
-- Barra (Rebanada): 1 Barras → 6 rebanadas
INSERT INTO product_pack_yields (product_id, input_unit, pieces_per_input, source_product_id, cut_ratio, notes)
...
-- Conchas: gallon path mirrors dough_type Concha
INSERT INTO product_pack_yields (product_id, input_unit, trays_per_gallon, pieces_per_tray, notes)
...
-- Fino SKUs: gallon at dough level; product rows mark gallon + default sheet tray
INSERT INTO product_pack_yields (product_id, input_unit, trays_per_gallon, pieces_per_tray, notes)
...
-- Spelling / informal aliases (only where catalog product exists)
