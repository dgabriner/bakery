...
<main class="module-guide">
  ...
  <section class="module-guide__roles" aria-label="Role access summary">
    ...
    <article class="module-guide__role"><h2>Baker</h2><p>Daily Production, Mix Today, and Pack List only. Weekly planning, inventory, orders, and dispatch stay with management.</p></article>
